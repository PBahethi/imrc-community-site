(function(root){
  'use strict';
  const palettes={
    National:{label:'National',colors:['#153eaa','#ff9933','#138808','#000080','#edf2ff']},
  ...
  const chapterTheme={national:'National',northeast:'Jodhpur',mideast:'Jodhpur',midwest:'Udaipur',southwest:'Jaipur',southeast:'Jaisalmer','west-coast':'Peacock','canada-east':'Peacock','canada-west':'Jaisalmer'};
